    ...
    >
      ...
      <header className="mb-7 flex flex-wrap items-end justify-between gap-3.5 border-b border-[#E7D9C2] pb-[22px]">
        <div className="flex flex-col gap-2.5">
          <div className="h-9 w-48 animate-pulse rounded bg-[#EFE3D0]" />
          <div className="h-3 w-24 animate-pulse rounded bg-[#EFE3D0]" />
        </div>
        <div className="h-9 w-32 animate-pulse rounded bg-[#EFE3D0]" />
      </header>

      <div className="flex flex-col gap-9 lg:flex-row lg:items-start">
        <div className="hidden w-[220px] shrink-0 flex-col gap-5 lg:flex">
          <div className="h-40 animate-pulse rounded bg-[#EFE3D0]" />
          <div className="h-24 animate-pulse rounded bg-[#EFE3D0]" />
          <div className="h-16 animate-pulse rounded bg-[#EFE3D0]" />
        </div>
          ...
          {Array.from({ length: 6 }, (_, i) => (
            ...
            >
              ...
              <div className="flex flex-col gap-2.5 px-4 pb-[18px] pt-4">
                ...
                <div className="h-5 w-3/4 animate-pulse rounded bg-[#EFE3D0]" />
