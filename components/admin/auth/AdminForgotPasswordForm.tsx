...
import { AuthError, AuthField, AuthLink, AuthSubmit } from "@/components/storefront/auth/AuthCard"
  ...
  if (sentTo) {
    return (
      <p className="m-0 text-[14px] leading-relaxed text-[#5E4A44]">
        If an admin account exists for <span className="font-medium text-maroon-900">{sentTo}</span>
