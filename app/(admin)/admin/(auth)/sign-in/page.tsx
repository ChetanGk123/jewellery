...
export default async function AdminSignInPage({ searchParams }: { searchParams: Search }) {
  ...
  return (
    <AdminAuthShell title="Welcome back" subtitle="Sign in to the RJ Jewellers admin console.">
      {error && (
        <AuthError
          message={
            error === "expired"
