...
const DECLINE_MESSAGE = "We couldn't send your message just now. Please try again in a moment."
const RATE_LIMITED_MESSAGE = "Too many messages sent — please try again in a few minutes."
