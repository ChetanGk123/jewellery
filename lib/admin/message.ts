...
export const MESSAGE_FILTERS: MessageFilter[] = ["All", "New", "In Progress", "Resolved"]

/** The real ticket statuses (the tabs minus the catch-all "All"). */
export const MESSAGE_STATUSES: MessageStatus[] = ["New", "In Progress", "Resolved"]
...
export function toMessageFilter(value: string | undefined): MessageFilter {
  return value && (MESSAGE_FILTERS as string[]).includes(value) ? (value as MessageFilter) : "New"
}
